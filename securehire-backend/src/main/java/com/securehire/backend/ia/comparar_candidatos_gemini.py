...
- puntajeRequisitosClave (hasta 45 puntos): tecnologías, herramientas o conocimientos clave requeridos
- puntajeExperienciaLaboral (hasta 20 puntos): experiencia laboral comprobable
...
- puntajeOtros (hasta 10 puntos): certificaciones, cursos, logros u otro valor agregado
...
📝 Nuevo requisito:
Por cada apartado evaluado, devolvé también una explicación breve en el campo `explicacionesPorCriterio`, con una oración de 1 o 2 líneas como máximo, que justifique por qué recibió ese puntaje. No repitas lo mismo en varios candidatos. Por ejemplo:

"explicacionesPorCriterio": {{
  "requisitosClave": "Conoce Java y Spring Boot, pero no menciona React.",
  "experienciaLaboral": "Tuvo una pasantía en una empresa de tecnología durante 6 meses.",
  "formacionAcademica": "Está cursando la carrera de Ingeniería en Sistemas.",
  "idiomasYSoftSkills": "Nivel intermedio de inglés y habilidades blandas destacadas.",
  "otros": "Cuenta con certificación en Python."
}}
